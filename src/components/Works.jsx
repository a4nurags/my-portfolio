    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          The following projects highlight my UI/UX design skills through real-world work. Each project showcases responsive web and mobile app screens, focusing on usability, visual clarity, and user-centered design solutions.
        </p>
      </div>
